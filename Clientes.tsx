...
// const {clienteRef, botonRef, filtradoRef, theadRefs, tablaMedida} = useHeightTabla()
  ...
  const abrirModalEdicion = (index: any) => {
  ...
  const calcularMontoTotalConIVA = (item: nuevoProducto) => {
...
// Función para ordenar los productos según el criterio seleccionado por el minimo
  const sortMinimo = (criterio: string) => {
  ...
  const handleSortOptionMinimo = (option: any) => {
    (option.label); // Actualizar el estado del criterio de ordenamiento seleccionado
...
const sortMaximo = (criterio: string) => {
  const sortedData = [...datosTabla];
...
// Función para manejar el cambio de opción en el menú desplegable
const handleSortOptionMaximo = (option: any) => {
  (option.label); // Actualizar el estado del criterio de ordenamiento seleccionado
...
const sortExistencias = (criterio: string) => {
  const sortedData = [...datosTabla];
...
// Función para manejar el cambio de opción en el menú desplegable
const handleSortOptionexitencias = (option: any) => {
  (option.label); // Actualizar el estado del criterio de ordenamiento seleccionado
  ...
  const sortProductos = (criterio: string) => {
    const sortedData = [...datosTabla];
      ...
      <div  className="bg-gray-200 p-2 mb-2">{/* ref={filtradoRef} */}
        ...
        <div>
          <div className={ ' flex space-x-2 gap-3 mb-2'}>
            ...
            <select onChange={(e)=> setValueSelect(e.target.value as keyof nuevoProducto)}>
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <p>Minimo</p><Input type='number' value={minimo} onChange={(e) => setMinimo(e.target.value)}/>
            <p>Maximo</p><Input type='number' value={maximo} onChange={(e) => setMaximo(e.target.value)}/>
            <p>Existencias</p><Input type='number' value={existencias} onChange={(e) => setExistencias(e.target.value)}/>
            <p>Subtotal</p><Input type='number' value={subtotal} onChange={(e) => setSubtotal(e.target.value)}/>
          </div>
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <p>Minimo</p><Input type='number' value={minimoEdit} onChange={(e) => setMinimoEdit(e.target.value)}/>
            <p>Maximo</p><Input type='number' value={maximoEdit} onChange={(e) => setMaximoEdit(e.target.value)}/>
            <p>Existencias</p><Input type='number' value={existenciasEdit} onChange={(e) => setExistenciasEdit(e.target.value)}/>
            <p>Subtotal</p><Input type='number' value={subtotalEdit} onChange={(e) => setSubtotalEdit(e.target.value)}/>
          </div>
          <div className="modal-footer">
